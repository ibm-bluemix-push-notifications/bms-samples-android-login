...
public class SubscribeActivity  extends Activity implements View.OnClickListener{
    ...
    private void alerts(String message){
    ...
    void displayTags() {
        push.getTags(new MFPPushResponseListener<List<String>>() {
            ...
            public void onSuccess(List<String> tags) {
                ...
                ((TextView) findViewById(R.id.get_tags)).setText(tags.toString());
            }
    ...
    void subscribeToTag() {
        ...
        String str = ((EditText)findViewById(R.id.get_tags)).getText().toString();
        List<String> allTags = Arrays.asList(str.split("\\s*,\\s*"));
